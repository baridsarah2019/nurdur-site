  ...
  ar: {
    ...
    servicesPreview: {
      ...
      cards: [
        {
          title: "إنشاء المباني",
          description: "أعمال إنشاءات تجارية وسكنية وحكومية تشمل الخدمات الصحية والكهربائية وأنظمة التكييف.",
        },
        {
          title: "الأعمال المدنية والبنى التحتية",
          description: "أعمال ترابية وصبّات خرسانية ورصف أسفلتي وأعمال دق الركائز للطرق والجسور ومشاريع البنى التحتية.",
        },
        {
          title: "الأعمال الكهربائية",
          description: "تنفيذ منظومات الجهد المتوسط/العالي والمحطات والأعمدة وكوابل الألياف الضوئية.",
        },
        {
